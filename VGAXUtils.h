...
public:
  ...
  static inline void draw_line(uint8_t x0, uint8_t y0, uint8_t x1, uint8_t y1, uint8_t c) {
  ...
  static inline void draw_circle(uint8_t x0, uint8_t y0, uint8_t radius, uint8_t c, char fc) {
    int f=1-radius;
    int ddF_x=1;
    int ddF_y=-2 * radius;
    int x=0;
  ...
  static inline void draw_rect(uint8_t x0, uint8_t y0, uint8_t w, uint8_t h, uint8_t c, char fc) {
    if (fc != -1) {
